...
import com.nhnacademy.nhnmartservicecenter.exception.InquiryNotFoundException;
...
public class InquiryRepositoryImpl implements InquiryRepository {
    ...
    public InquiryRepositoryImpl(){
        ...
        inquiryMap.put(inquiryCount,new Inquiry(inquiryCount++,"444","444","접근에러","접근이 안되요", Inquiry.category.ETC,null,null));
